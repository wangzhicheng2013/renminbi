...
RenMinBi.o : $(USER_DIR)/RenMinBi.cpp $(USER_DIR)/RenMinBi.h $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(USER_DIR)/RenMinBi.cpp

test.o : $(USER_DIR)/test.cpp $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(USER_DIR)/test.cpp

test_unittest : RenMinBi.o test.o gtest_main.a
